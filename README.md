...
Data is stored in standard XDG directories (under `taskii/` in `$XDG_DATA_HOME` for tasks and notes, and `$XDG_CONFIG_HOME` for settings), created automatically on first run.
